...
class CodeZy extends CodeBlock{
    public CodeZy() { System.out.println("===========code 构造方法==========="); }
    static { System.out.println("===========code 静态块==========="); }
    { System.out.println("===========code  代码块==========="); }
}
public class  CodeBlock  {
    static { System.out.println("===========CodeBlock 静态代码块==========="); }
    { System.out.println("===========CodeBlock  代码块==========="); }
    public CodeBlock() { System.out.println("===========CodeBlock  构造方法==========="); }
